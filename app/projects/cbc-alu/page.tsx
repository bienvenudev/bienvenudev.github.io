    ...
    <article className="max-w-[720px] mx-auto mt-24 mb-24">
      ...
      <div className="text-center mb-10">
        ...
        <div className="flex justify-center gap-5 mt-5">
          ...
          {/* TODO: verify GitHub repo URL before publishing */}
          <a
            href="https://github.com/bienvenudev/cbc-alu"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm font-semibold text-(--accent) hover:underline no-underline"
          >
      ...
      <p className="text-(--text-muted) leading-[1.8] mb-[0.9rem]">
        Claude Builder Clubs are{" "}
        <strong className="text-(--text)">Anthropic&apos;s official student-led campus communities</strong>,
      ...
      <p className="text-(--text-muted) leading-[1.8] mb-[0.9rem]">
        ...
        ALU chapter — where I serve as a{" "}
